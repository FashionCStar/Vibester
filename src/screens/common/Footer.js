...
import {View,  SafeAreaView, ImageBackground,StatusBar,Image,Platform,Text,TouchableOpacity,Alert} from 'react-native';
    ...
    SelectCamera = (type) => {
        ...
        ImagePicker.launchImageLibrary(options, (response) => {
          ...
          if (response.didCancel) {
            ...
            if(type=="video")
            {
              NavigationService.navigate("VideoPreview",{image_uri:response.path});
            }
          }
        });
      }
